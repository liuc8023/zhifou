...
/**
* @className HubResponseHead
* @description 枢纽响应报文头
* @author liuc
* @date 2019-11-01 11:09
* @since JDK 1.8
**/
@JsonInclude(JsonInclude.Include.NON_NULL)
@ApiModel(value="响应报文头",description="响应报文头")
public class HubResponseHead {

    public HubResponseHead(){
        HubResponseCode[] code = new HubResponseCode[1];
        code[0] = new HubResponseCode();
     ...
     * 目标系统编号
     */
    @ApiModelProperty(value="目标系统编号",name="targetId",required = false,example="")
     ...
     * 服务方系统流水号
     */
    @ApiModelProperty(value="服务方系统流水号",name="splrSeqNo",required = false,example="")
     ...
     * 交易返回状态
     */
    @ApiModelProperty(value="交易返回状态",name="returnStatus",required = false,example="")
    private String returnStatus = "S";

    /**
     * 枢纽响应码及响应信息
     */
    @ApiModelProperty(value="枢纽响应码及响应信息",name="ret",required = false,example="")
    private HubResponseCode[] ret;
     ...
     * 目标服务器标志
     */
    @ApiModelProperty(value="目标服务器标志",name="destSvrId",required = false,example="")
     ...
     * 总记录数
     */
    @ApiModelProperty(value="总记录数",name="totalNum",required = false,example="")
    ...
    public HubResponseCode[] getRet() {
        return ret;
    }

    public void setRet(HubResponseCode[] ret) {
        this.ret = ret;
    }
