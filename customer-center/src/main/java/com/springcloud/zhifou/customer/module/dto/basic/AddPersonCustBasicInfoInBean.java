...
/**
 * 创建个人客户基础信息输入bean
 * @className: AddPersonCustBasicInfoInBean
 * @author: liuc
 * @date: 2019-12-12
 */
@Data
@ApiModel(value="创建个人客户基础信息输入bean",description="创建个人客户基础信息输入bean")
public class AddPersonCustBasicInfoInBean {
    @ApiModelProperty(name = "custNo", value = "客户标识", required = true, dataType = "String", example = "")
    private String custNo;

    @ApiModelProperty(name = "custName", value = "客户名称", required = true, dataType = "String", example = "")
