...
/**
 * 修改个人客户基础信息输入bean
 * @className: UpdatePersonCustBasicInfoInBean
 * @author: liuc
 * @date: 2019-12-12
 */
@Data
@ApiModel(value="修改个人客户基础信息输入bean",description="修改个人客户基础信息输入bean")
public class UpdatePersonCustBasicInfoInBean {
    @ApiModelProperty(name = "custNo", required = true, value = "客户标识", dataType = "String", example = "")
    private String custNo;

    @ApiModelProperty(name = "custName", required = true, value = "客户名称", dataType = "String", example = "")
    ...
    @ApiModelProperty(name = "existingCustomer", required = true, value = "正式客户标志", dataType = "String", example = "")
    ...
    @ApiModelProperty(name = "principalLinkman", value = "9要素维护员工编号", dataType = "String", example = "")
